...
export const content: Routes = [
    ...
    {
        path: 'ban-doc',
        loadChildren: () => import('../../pages/quanlythuvien/bandoc/bandoc.module').then(m => m.BandocModule)
    },
    {
        path: 'nxb',
        loadChildren: () => import('../../pages/quanlythuvien/nha-xuat-ban/nha-xuat-ban.module').then(m => m.NhaXuatBanModule)
    },
    {
        path: 'tac-gia',
        loadChildren: () => import('../../pages/quanlythuvien/tac-gia/tac-gia.module').then(m => m.TacGiaModule)
    },
    {
        path: 'sach',
        loadChildren: () => import('../../pages/quanlythuvien/sach/sach.module').then(m => m.SachModule)
    },

    {
        path: 'muon-sach',
        loadChildren: () => import('../../pages/quanlythuvien/muon-sach/muon-sach.module').then(m => m.MuonSachModule)
    },
];
